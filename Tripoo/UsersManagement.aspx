<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersManagement.aspx.cs" Inherits="Tripoo.UsersManagement" %>
...
<body>
    ...
    <div>
        ...
        <div style="height:50px; padding:25px;">
            ...
            <asp:Button ID="btnAddUser" runat="server" Text="Add user" BackColor="#336699" ForeColor="White" Font-Size="15px" Width="150px" Height="50px" BorderStyle="Groove"  onclick="btnAddUser_Click"/>
        </div>
