<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripsManagement.aspx.cs" Inherits="Tripoo.TripsManagement" %>
...
<body>
    ...
    <div>
        ...
        <div style="height:50px; padding:25px;">
            ...
            <asp:Button ID="btnAddTrip" runat="server" Text="Add trip" BackColor="#336699" ForeColor="White" Font-Size="15px" Width="150px" Height="50px" BorderStyle="Groove"  onclick="btnAddTrip_Click"/>
        </div>
