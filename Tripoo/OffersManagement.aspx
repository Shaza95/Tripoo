<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OffersManagement.aspx.cs" Inherits="Tripoo.OffersManagement" %>
...
<body>
    ...
    <div>
        ...
        <div style="height:50px; padding:25px;">
            ...
            <asp:Button ID="btnAddOffer" runat="server" Text="Add offer" BackColor="#336699" ForeColor="White" Font-Size="15px" Width="150px" Height="50px" BorderStyle="Groove"  onclick="btnAddOffer_Click"/>
        </div>
