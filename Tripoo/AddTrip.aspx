<%@ Page Language="C#" AutoEventWireup="true" UnobtrusiveValidationMode="None" ValidateRequest="false" CodeBehind="AddTrip.aspx.cs" Inherits="Tripoo.AddTrip" %>
    ...
    <form id="form1" runat="server">
        <div style="margin:0 0 auto; margin-left: 400px; margin-top: 5px; width: 500px; padding-top:5px; background-image:url('images/2.jpg')">
            ...
            <table style="margin-left:85px;">
                ...
                <tr>
                    <td>
                        <input style="color:#0B1054; background-color:transparent; height:40px; width:315px; padding-left:15px" id="txtPrice" runat="server" type="number" placeholder="Price"/>
                    </td>
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Enter price"  ControlToValidate="txtPrice"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Conn1 %>" SelectCommand="SELECT [Id], [Name] FROM [Transports]"></asp:SqlDataSource>
                    </td>
                    <td>
