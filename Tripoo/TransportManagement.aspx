<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportManagement.aspx.cs" Inherits="Tripoo.TransportManagement" %>
...
<body>
    ...
    <div>
        ...
        <div style="height:50px; padding:25px;">
            ...
            <asp:Button ID="btnAddTransport" runat="server" Text="Add transport" BackColor="#336699" ForeColor="White" Font-Size="15px" Width="150px" Height="50px" BorderStyle="Groove"  onclick="btnAddTransport_Click"/>
        </div>
